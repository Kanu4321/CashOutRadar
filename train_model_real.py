...
2. There is no `cashouts.csv` telling us which account is a cash-out
   node. Ground truth instead comes from `HI-Small_Patterns.txt`,
...
INPUTS (edit DATA_DIR below or set env var)
  <DATA_DIR>/HI-Small_Trans.csv       (or HI-Medium / HI-Large)
  <DATA_DIR>/HI-Small_accounts.csv
  <DATA_DIR>/HI-Small_Patterns.txt
...
DATASET_PREFIX = os.environ.get("DATASET_PREFIX", "HI-Small")  # HI-Small / HI-Medium / HI-Large
